...
export default function RelationshipStorySite() {
  ...
  const memories = [
    {
      ...
      image: "/mnt/data/WhatsApp Image 2026-04-25 at 10.44.37(1).jpeg",
    },
    {
      title: "Our Mall Date ❤️",
      image: "/mnt/data/Snapchat-450202210.jpg",
    },
    {
      title: "My Favourite Mirror Memory",
      image: "/mnt/data/Snapchat-312089054 (1).jpg",
    },
    {
      title: "The Cutest Version Of You",
      image: "/mnt/data/Snapchat-288525885.jpg",
    },
  ];
  ...
  const episodes = [
    ...
    },
    {
      ...
      season: "Episode 4",
      desc: "I know my emotions sometimes became too heavy and overwhelming. I hate that I hurt someone I loved so deeply.",
      image: "/mnt/data/Snapchat-528061161.jpg",
    },
    {
      title: "If We Ever Try Again",
      season: "Final Episode",
      desc: "I’d love you more gently, communicate better, and protect your peace instead of adding to your stress.",
      image: "/mnt/data/Snapchat-288525885.jpg",
    },
  ];
  ...
  return (
    <div className="bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/mnt/data/Snapchat-450202210.jpg')",
        }}
      >
      ...
      <section className="px-6 md:px-14 py-16">
        <h3 className="text-4xl font-black mb-10">Our Memories ❤️</h3>
      ...
      <section className="px-6 md:px-14 py-16">
        <h3 className="text-4xl font-black mb-10">Continue Watching</h3>
